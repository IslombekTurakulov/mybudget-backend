package ru.iuturakulov.mybudgetbackend.entities
...
abstract class BaseIntIdTable(name: String) : IdTable<String>(name) {
    final override val id: Column<EntityID<String>> = varchar("id", 50).clientDefault {
...
private fun currentUtc(): LocalDateTime {

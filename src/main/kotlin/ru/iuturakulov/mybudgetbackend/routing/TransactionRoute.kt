...
fun Route.transactionRoute(transactionController: TransactionController, auditLogService: AuditLogService) {
    route("projects/{projectId}/transactions") {
        ...
        get({
            ...
            call.respond(ApiResponseState.success(transactions, HttpStatusCode.OK))
        }
        ...
        get("{transactionId}", {
            ...
            call.respond(ApiResponseState.success(transaction, HttpStatusCode.OK))
        }
        ...
        post({
            ...
            call.respond(ApiResponseState.success(transaction, HttpStatusCode.Created))
        }
        ...
        put("{transactionId}", {
            ...
            if (success) {
                ...
                call.respond(ApiResponseState.success("Транзакция обновлена", HttpStatusCode.OK))
            } else {
                call.respond(ApiResponseState.failure("Ошибка обновления транзакции", HttpStatusCode.BadRequest))
            }
        }
        ...
        delete("{transactionId}", {
            ...
            val transactionId =
                call.parameters["transactionId"] ?: return@delete call.respondBadRequest("Transaction ID is required")
            ...
            call.respond(ApiResponseState.success("Транзакция удалена", HttpStatusCode.OK))
        }
    }
}
